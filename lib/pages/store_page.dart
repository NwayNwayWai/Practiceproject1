...
import 'package:practiseapp1/theme/colors.dart';
...
class _StorePageState extends State<StorePage> {
  ...
  Widget getBody(){
    return SafeArea(
      ...
      children: [
         ...
         padding: const EdgeInsets.only(top: 30,left: 20,right: 20),
            ...
            children: [
                Text("Phnom Penh",style: TextStyle(color: black,
                 fontSize: 16),),
                 SizedBox(width: 10,),
          ...
          SizedBox(height: 40,),
              Padding(
                ...
                child: Text("Find all \nstores here",style: TextStyle(color: black,
        ...
        Padding(
          padding: const EdgeInsets.only(left: 20,right: 20),
          child: Text("All stores",style: TextStyle(color:Colors.black,fontSize: 22),
          ),
        ),
        SizedBox(
          height: 20,
    ...
    width: double.infinity,
    decoration: BoxDecoration(
    image: DecorationImage(image: NetworkImage(storeList[index]['img']),
    fit: BoxFit.cover),
    ...
    child: storeList[index]['open'] == 0 ? Row(
      ...
      children: [
        Text("CLOSE",style: TextStyle(fontSize: 10,color: black,
      ...
      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
      children: [
        Text("OPEN",style: TextStyle(fontSize: 10,color: black,
            fontWeight: FontWeight.bold),
        ),
        Container(
          width: 8,
